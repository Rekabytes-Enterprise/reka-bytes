...
export const metadata: Metadata = {
  title: 'Reka Bytes Academy — learn to vibe code properly',
  description:
    'Hands-on vibe coding classes for non-CS people — paired with the software engineering fundamentals most vibe coders skip. Small cohorts, real fundamentals.',
};
