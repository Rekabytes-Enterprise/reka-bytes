const LOCAL_BACKEND_URL = 'http://localhost:4300';
 ...
 * of the Next server and nothing else — one image then serves any host.
 *
 * Value has no trailing slash and no `/api` suffix: `BACKEND_URL=http://backend:4300`.
 */
